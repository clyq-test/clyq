        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'center',height:'44px'}}>
          {[
            ...
            <a key={item.label} href={item.href}
              style={{padding:'0 16px',height:'44px',display:'flex',alignItems:'center',fontSize:'12px',color:'#666',textDecoration:'none',letterSpacing:'0.5px',borderBottom:'2px solid transparent',transition:'all 0.15s'}}
          ...
          <a href="/fitting"
            style={{padding:'0 16px',height:'44px',display:'flex',alignItems:'center',fontSize:'12px',color:'#C94E1A',textDecoration:'none',fontWeight:500,letterSpacing:'0.5px',borderBottom:'2px solid transparent',transition:'all 0.15s'}}
